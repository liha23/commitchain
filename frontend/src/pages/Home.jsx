      ...
      <section className="py-20 avalanche-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            {isConnected ? (
              <Link to="/groups/create" className="btn bg-white text-red-600 hover:bg-gray-100 text-lg px-8 py-3">
              ...
              <button
                onClick={connectWallet}
                className="btn bg-white text-red-600 hover:bg-gray-100 text-lg px-8 py-3"
              >
