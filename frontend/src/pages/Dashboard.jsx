    ...
    <div className="min-h-screen gradient-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-300">Welcome back! Here's your commitment overview.</p>
        </div>
              ...
              <div className="space-y-4">
                {recentGroups.map((group, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    className="border border-gray-800 rounded-lg p-4 hover:shadow-md hover:shadow-red-900/20 transition-all bg-gray-950/50"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-3 gap-3 text-sm">
                          <div className="flex flex-col items-center p-2 bg-gray-900/50 rounded">
                            ...
                            <span className="text-gray-200 font-semibold">{group.members}</span>
                            <span className="text-gray-400 text-xs">Members</span>
                          </div>
                          <div className="flex flex-col items-center p-2 bg-gray-900/50 rounded">
                            <Trophy className="w-4 h-4 text-red-400 mb-1" />
                            <span className="text-gray-200 font-semibold">{group.stakeAmount} AVAX</span>
                            <span className="text-gray-400 text-xs">Stake</span>
                          </div>
                          <div className="flex flex-col items-center p-2 bg-gray-900/50 rounded">
                            <Calendar className="w-4 h-4 text-red-400 mb-1" />
                            <span className="text-gray-200 font-semibold">{group.deadline.split('-')[1]}/{group.deadline.split('-')[2]}</span>
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        <div className="text-right">
                          <div className="text-sm font-medium text-white">{group.progress}%</div>
              ...
              <div className="space-y-3">
                {upcomingDeadlines.map((deadline, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-white">{deadline.groupName}</h4>
                        <p className="text-sm text-gray-300">{deadline.deadline}</p>
                      </div>
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-200">Completed LeetCode problem #87</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-200">Joined "Fitness Warriors" group</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-200">Milestone reached: 50% progress</p>
